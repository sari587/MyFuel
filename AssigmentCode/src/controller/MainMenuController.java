...
public class MainMenuController {
	...
	private void configureView() {
		...
		configureTab(userProfileTab, "User\nProfile", "/gui/user-profile.png", userProfileContainer,
				getClass().getResource("userprofile.fxml"), replaceBackgroundColorHandler);
		configureTab(settingsTab, "Settings", "/gui/settings.png", settingsContainer,
				getClass().getResource("settings.fxml"), replaceBackgroundColorHandler);
		configureTab(ordersTab, "Orders", "/gui/settings.png", OrdersContainer, getClass().getResource("settings.fxml"),
				replaceBackgroundColorHandler);
		configureTab(PaymentsTap, "Payments", "/gui/settings.png", PaymentsCountainer,
				getClass().getResource("settings.fxml"), replaceBackgroundColorHandler);
